...
public class SliderAdapter extends SliderViewAdapter<SliderAdapter.SliderAdapterVH> {
    ...
    public SliderAdapter(Context context, ArrayList<SliderItem> sliderItemArrayList) {
    ...
    public SliderAdapterVH onCreateViewHolder(ViewGroup parent) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.raw_img_sllider, null);
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, final int position) {
       ...
       viewHolder.imageViewBackground.setImageResource(sliderItem.getImgData());
        viewHolder.textViewDescription.setText(sliderItem.getStrImag());
